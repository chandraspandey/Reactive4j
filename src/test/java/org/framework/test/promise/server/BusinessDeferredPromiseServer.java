...
public final class BusinessDeferredPromiseServer implements PromiseTypeServer{
    ...
    public static void setCallbackHandler(CallbackHandler handler) {
        ...
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : setCallbackHandler : "+callbackHandler);
    }
    ...
    public ProgressScale buildProgressScale(PromisableType promisableType,double now) throws PromiseException{
        ...
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : "+progressScale);
    ...
    public Scale invokeAndReturn(RequestModel request, RequestScale requestScale) throws PromiseException {
        ...
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : invokeAndReturn : "+scale);
    ...
    public ProgressScale invokeForProgress(String acknowledgmentIdentifier) throws PromiseException {
        ...
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : invokeForProgress : "+scale);
    ...
    public BusinessPromiseMockResponse invokeWhenComplete(String acknowledgmentIdentifier) throws PromiseException{
        ...
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : invokeWhenComplete : "+
    ...
    public Scale negotiate(RequestScale requestScale) throws PromiseException {
        ...
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : callbackHandler : "+callbackHandler);
        
        callbackHandler.doCallback(
                new SimpleEntry<>(CallbackType.SERVER,scale)
        );
        Logger.getRootLogger().info("BusinessDeferredPromiseServer : negotiate : "+scale);
