...
import org.framework.test.promise.client.BusinessPromiseClient;
import org.junit.Test;

public class PromiseTest extends FrameworkTest{

        
    @Test
    public void testConfig() throws ConfigurationException{
        
        BusinessPromiseClient businessPromiseClient = (BusinessPromiseClient) promiseClient();
   ...
   private static PromiseTypeClient promiseClient() throws ConfigurationException{
        ...
        return app.createPromiseTypeClient(
            ...
            new PromiseConfigBuilder()
                .withPromiseTypeClientAs(new BusinessPromiseClient())
