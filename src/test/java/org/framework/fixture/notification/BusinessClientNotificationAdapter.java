...
public class BusinessClientNotificationAdapter extends AbstractDefaultAdapter {
    ...
    private Subscriber<? super Event<EventModel>> subscriber = new BusinessClientAdministrator();
