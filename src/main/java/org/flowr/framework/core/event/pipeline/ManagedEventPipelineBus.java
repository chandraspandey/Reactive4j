...
public class ManagedEventPipelineBus implements EventBus {
    ...
    public EventPipeline lookup(String pipelineName,PipelineType pipelineType, PipelineFunctionType 
        ...
        Logger.getRootLogger().info("ManagedEventPipelineBus : eventPipeline : "+eventPipeline);
    ...
    public String toString() {
        ...
        return "ManagedEventPipelineBus { pipelineType : "+pipelineType+" | "+pipelineList+" } ";
    }
