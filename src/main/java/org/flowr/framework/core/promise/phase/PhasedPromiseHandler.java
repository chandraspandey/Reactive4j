...
public class PhasedPromiseHandler implements PhasedPromise{
    ...
    public PromiseResponse what(PromiseRequest promiseRequest) throws PromiseException {
        ...
        try {
            ...
            while(
                ...
                if(promiseResponse.getProgressScale() != null && 
                        !snapshotScale.equals(promiseResponse.getProgressScale())){
                    
                    snapshotScale.clone((PhasedProgressScale)promiseResponse.getProgressScale());
                    
                    chunkValue = snapshotScale.getChunkBuffer();
                    
                    timeline = processChunkValue(snapshotScale, timeline, chunkBuffer, chunkValue);
    ...
    private Timeline processChunkValue(PhasedProgressScale snapshotScale, Timeline timeline, ChunkBuffer chunkBuffer,
    ...
    public PromiseResponse iterate(PromiseRequest promiseRequest) throws PromiseException {
        ...
        PhasedPromiseTask promiseTask = new PhasedPromiseTask(promiseRequest,reactiveTarget);
    ...
    public void publishClientEvent(EventType eventType, Scale scale) {
        ...
        Logger.getRootLogger().info("PhasedPromiseHandler : publishClientEvent : "+changeEvent);
