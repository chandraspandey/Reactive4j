...
public class PromiseHandler implements Promise,SingleEventPublisher{
    ...
    public void publishClientEvent(EventType eventType, Scale scale) {
        ...
        Logger.getRootLogger().info("PromiseHandler : publishClientEvent : "+changeEvent);
    ...
    public void startup(){
        ...
        processHandler.publishProcessEvent(EventType.SERVER,Context.getProcessLifecycleContext(serverIdentifier, 
                PromiseServerState.REGISTERED,PromiseServerStatus.STARTED, 
                processIdentifier,this.getClass().getName()));
    }
    ...
    public void shutdown() {
        ...
        processHandler.publishProcessEvent(EventType.SERVER,Context.getProcessLifecycleContext(serverIdentifier, 
                PromiseServerState.UNREGISTERED,PromiseServerStatus.SHUTDOWN, 
                processIdentifier,this.getClass().getName()));
    ...
    public void publishEvent(Event<EventModel> event) {
        ...
        Logger.getRootLogger().info("PromiseHandler : publishEvent = "+event);
