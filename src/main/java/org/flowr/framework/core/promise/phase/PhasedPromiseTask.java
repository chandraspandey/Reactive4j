...
public class PhasedPromiseTask<REQUEST,RESPONSE> implements 
	...
	public PhasedPromiseTask(PromiseRequest<REQUEST,RESPONSE> promiseRequest,ReactiveTarget<REQUEST,RESPONSE> reactiveTarget){
	...
	public PromiseResponse<RESPONSE> honorPromise() throws PromiseException, ConfigurationException {
		...
		//System.out.println("PhasedPromiseTask : honorPromise : identifier : "+identifier);
		...
		//System.out.println("PhasedPromiseTask : honorPromise : promiseResponse = "+promiseResponse);
	...
	public PromiseResponse<RESPONSE> handleTimeout(ResponseCode responseCode){
		...
		System.out.println("PhasedPromiseTask : buildTimeoutScale : promiseResponse = "+promiseResponse);
