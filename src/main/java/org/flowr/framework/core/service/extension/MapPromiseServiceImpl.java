...
public class MapPromiseServiceImpl extends AbstractService implements MapPromiseService{

   
    private ServiceConfig serviceConfig         = new ServiceConfig(
                                                    true,
                                                    ServiceUnit.SINGELTON,
                                                    FrameworkConstants.FRAMEWORK_SERVICE_PROMISE_MAP,
                                                    ServiceType.PROMISE_MAP,
