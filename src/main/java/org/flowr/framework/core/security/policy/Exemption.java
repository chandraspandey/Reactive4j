...
public interface Exemption{
	...
	//public void setExemptionMode(AttributeSet<ExemptionMode,Attribute> exemptionMode);
	
	public void setExemptionMode(AttributeSet exemptionMode);
	
	public AttributeSet getExemptionMode();
	 ...
	 */
	public void setExemptionCalendar(ScheduleCalendar scheduleCalendar);
	
	public ScheduleCalendar getExemptionCalendar();
}
