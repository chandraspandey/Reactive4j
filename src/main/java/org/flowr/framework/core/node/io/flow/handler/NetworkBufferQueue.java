...
public class NetworkBufferQueue implements NotificationQueue {
	...
	private static LinkedTransferQueue<NetworkByteBuffer> bufferQueue 	= new LinkedTransferQueue<NetworkByteBuffer>();
	...
	public String toString() {
		...
		return "NotificationBufferQueue { "+queueType+" | "+queueStagingType+" | "+eventType+" | "+bufferQueue.size()+" } ";
	}
