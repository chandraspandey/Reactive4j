...
public class LocalApplicationGroup extends NodeApplicationGroup{

	private NetworkEntry serverNetworkEntry					= new NetworkEntry();
	private ArrayList<NetworkEntry> clientNetworkEntryList	= new ArrayList<NetworkEntry>();
	...
	public NetworkGroupStatus deregisterSocketAddress(NetworkGroupRoleType networkGroupRoleType,SocketAddress socketAddress) {
		...
		switch(networkGroupRoleType) {
			...
			case CLIENT:{
				...
				if(clientNetworkEntryList.remove(new NetworkEntry(this.getGroupName(),networkGroupRoleType,socketAddress))) {
	...
	public ArrayList<NetworkEntry> getClientNetworkEntryList() {
