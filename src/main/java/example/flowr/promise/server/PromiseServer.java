...
public class PromiseServer implements PromiseTypeServer<PROMISE_MOCK_REQUEST,PROMISE_MOCK_RESPONSE>{
	...
	public ProgressScale invokeForProgress(String acknowledgmentIdentifier) throws PromiseException,ConfigurationException {
		...
		ProgressScale scale = buildProgressScale(promisableType,artificialNow);
