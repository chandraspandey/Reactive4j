...
public class DefferedPromiseClient<REQUEST, RESPONSE> implements PromiseTypeClient<REQUEST, RESPONSE> {
	...
	public ClientIdentity buildClientIdentity() throws ConfigurationException{
		...
		ClientIdentity clientIdentity = new ClientIdentity(DefferedPromiseClient.class.getSimpleName(),ClientType.PERSISTENT);
	...
	public void run() {
		...
		try {
			...
			if(isConfigured){
				...
				System.out.println("DefferedPromiseClient : Response = "+response);	
