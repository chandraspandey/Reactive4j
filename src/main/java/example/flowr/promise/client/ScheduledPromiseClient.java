...
public class ScheduledPromiseClient extends AbstractPromiseClient {

    private ProcessBuilder builder                          = new ProcessBuilder();
    
    public ScheduledPromiseClient() {
        super(RequestType.PROMISE_SCHEDULED,ScheduledPromiseClient.class.getSimpleName());
    }
    ...
    public PromiseTypeServer buildPromiseTypeServer() throws ConfigurationException{
        ...
        return new ScheduledPromiseServer();       
    }
    ...
    public void run(){
        ...
        try{
            ...
            if(isConfigured()){
                ...
                Logger.getRootLogger().info("ScheduledPromiseClient : Response = "+response);   
