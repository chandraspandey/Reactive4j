...
public class PromiseClient<REQUEST, RESPONSE> implements PromiseTypeClient<REQUEST, RESPONSE> {

	private boolean isConfigured;
	private RequestType requestType 						= RequestType.PROMISE;
	...
	public PromiseTypeServer<REQUEST, RESPONSE> buildPromiseTypeServer() throws ConfigurationException{
		...
		PromiseTypeServer<REQUEST, RESPONSE> integrationServer = 
			(PromiseTypeServer<REQUEST, RESPONSE>) new PromiseServer();
